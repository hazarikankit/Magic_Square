...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.endClick = function () {
        this.time_duration = 0;
        this.isStart = false;
        this.restart();
        this.clicks = 0;
    ...
    AppComponent.prototype.createBtns = function () {
        var _this = this;
        ...
        for (var j = 0; j < 4; j++) {
            for (var i = 0; i < 4; i++) {
                ...
                b.i = i;
                b.j = j;
                b.addEventListener("click", function (evt) { return _this.btnHandle(evt); }, false);
    ...
    AppComponent.prototype.checkFinished = function () {
        var a = 0;
        for (var j = 0; j < 4; j++) {
            for (var i = 0; i < 4; i++) {
                if (this.board[i][j] < a)
    ...
    AppComponent.prototype.getPossibles = function () {
    ...
    AppComponent.prototype.updateBtns = function () {
        var b, v, id;
        for (var j = 0; j < 4; j++) {
            for (var i = 0; i < 4; i++) {
                id = "btn" + (i + j * 4);
    ...
    AppComponent.prototype.btnHandle = function (e) {
        this.getPossibles();
